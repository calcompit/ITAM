  ...
  const handleVNC = async (ip: string, computerName: string) => {
    try {
      ...
      if (sessionResponse.ok) {
        ...
        if (result.existingSession) {
          session = {
            ...
            vncUrl: `${API_CONFIG.NOVNC_URL}/vnc.html?autoconnect=true&resize=scale&scale_cursor=true&clip=true&shared=true&repeaterID=&password=123`
          };
        }
      }
      ...
      if (session) {
        ...
        const vncUrl = session.vncUrl || `${API_CONFIG.NOVNC_URL}/vnc.html?autoconnect=true&resize=scale&scale_cursor=true&clip=true&shared=true&repeaterID=&password=123`;
